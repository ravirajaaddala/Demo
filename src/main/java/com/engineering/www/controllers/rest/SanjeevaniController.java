...
public class SanjeevaniController extends ApplicationRestController {
	...
	public @ResponseBody String add(@RequestBody DonorDetails s) {
		...
		try {
			...
			e.printStackTrace();
			resultVO.put("restcallstatus",
					"Thanks for your willingness. Failed to register. please contact customer support");
		}
	...
	@RequestMapping(value = "/getSegments/{orderNumber}", method = RequestMethod.GET)
	public @ResponseBody String getSegments(@PathVariable String orderNumber) {
		try {
